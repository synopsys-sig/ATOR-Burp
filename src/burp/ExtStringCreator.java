...
public class ExtStringCreator {
    ...
    public static String[] getStartStopString(String selectedText, String wholeText) {
        ...
        int startIndex = wholeText.indexOf(selectedText);
        int stopIndex = startIndex + selectedText.length();
